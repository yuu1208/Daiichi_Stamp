    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="contents">
                ...
                <div class="box">
                <h3>QRコードを読み込みました！</h3>
                <p style="font-size:20px;color:#FF9227;line-height:1.2">第一学院オリジナルキャラクター<br />「いちろう」のスタンプをゲットしました！</p>
                <p class="text">おめでとうございます！<br />
                コンプリート率が上昇！ スタンプ獲得リストに追加しました！</p>

                <div id="stampget"><img src="stamp/6.png" width="100%" alt="stamp"><p id="stamp_get_title">「いちろう」</p></div>
