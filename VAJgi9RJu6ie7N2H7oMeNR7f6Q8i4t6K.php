    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="contents">
                ...
                <div class="box">
                <h3>QRコードを読み込みました！</h3>
                <p style="font-size:20px;color:#FF9227;line-height:1.2">文化祭音ゲーの本家版から来た<br />「煽るペンギン」のスタンプをゲットしました！</p>
                <p class="text">おめでとうございます！<br />
                スタンプ獲得リストに追加しました！</p>
                <p class="text">（名前が大人の都合上出せないので伏せました）</p>

                <div id="stampget"><img src="stamp/5.png" width="100%" alt="stamp"><p id="stamp_get_title">「煽るペンギン」</p></div>
                <p class="text">左側の「マイページ」をタップするとコンプリート率を反映して戻ります。</p>
                <?php 
                $query = "UPDATE users SET stamp05_stat = '1' WHERE user_id=".$_SESSION['user']."";;
                $result = $mysqli->query($query);
                switch ($complete_per) {
                    case 0:
